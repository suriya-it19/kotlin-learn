...
//    check1 = "Second"
    ...
    var newStringT = "hello $name how are you"

    println(newString === newStringT) // same as is- checks both points to the same stringpool
    println(newString == newStringT) // same as compareTo() - only data
